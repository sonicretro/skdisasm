Snd_S3_Continue_Header:
	smpsHeaderStartSong 3
	smpsHeaderVoiceUVB
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $43

	smpsHeaderDAC       Snd_S3_Continue_DAC
	smpsHeaderFM        Snd_S3_Continue_FM1,	$18, $12
	smpsHeaderFM        Snd_S3_Continue_FM2,	$18, $10
	smpsHeaderFM        Snd_S3_Continue_FM3,	$0C, $14
	smpsHeaderFM        Snd_S3_Continue_FM4,	$0C, $0E
	smpsHeaderFM        Snd_S3_Continue_FM5,	$0C, $0E
	smpsHeaderPSG       Snd_S3_Continue_PSG1,	$F4, $04, $00, sTone_0C
	smpsHeaderPSG       Snd_S3_Continue_PSG2,	$F4, $04, $00, sTone_0C
	smpsHeaderPSG       Snd_S3_Continue_PSG3,	$00, $03, $00, sTone_0C
...
Snd_S3_Continue_Jump00:
	...
	smpsJump            Snd_S3_Continue_Jump00
...
Snd_S3_Continue_FM1:
	...
	smpsAlterNote       $01
	smpsPan             panRight, $00
	smpsCall            Snd_S3_Continue_Call00

Snd_S3_Continue_Call00:
	dc.b	nRst, $08, nEb4, $04, nE4, $08, nC4, $04, nD4, $08, nC4, $04
	dc.b	nA3, $08, nC4, $04

Snd_S3_Continue_Jump04:
	...
	smpsJump            Snd_S3_Continue_Jump04
...
Snd_S3_Continue_Jump03:
	...
	dc.b	nF1, $0B, nRst, $01, nFs1, $07, nRst, $01, nG1, $03, nRst, $09
	dc.b	nG0, $03, nRst, $01, nG0, $0B, nRst, $01
	smpsJump            Snd_S3_Continue_Jump03
...
Snd_S3_Continue_Jump02:
	...
	dc.b	nG3, $04
	smpsJump            Snd_S3_Continue_Jump02
...
Snd_S3_Continue_Jump01:
	...
	dc.b	nC4, $04
	smpsJump            Snd_S3_Continue_Jump01
...
; PSG1 Data
Snd_S3_Continue_PSG1:
	smpsPSGvoice        sTone_04
	dc.b	nRst, $30

Snd_S3_Continue_Jump07:
	...
	dc.b	nRst, $1A
	smpsJump            Snd_S3_Continue_Jump07

; Unreachable
	smpsStop

; PSG2 Data
Snd_S3_Continue_PSG2:
	smpsPSGvoice        sTone_04
	dc.b	nRst, $30

Snd_S3_Continue_Jump06:
	...
	dc.b	nRst, $1A
	smpsJump            Snd_S3_Continue_Jump06

; Unreachable
	smpsStop

; PSG3 Data
Snd_S3_Continue_PSG3:
	smpsPSGform         $E7

Snd_S3_Continue_Jump05:
	smpsPSGvoice        sTone_04
	dc.b	nMaxPSG2, $10
	...
	smpsPSGvoice        sTone_04
	dc.b	nMaxPSG2, $18
	smpsJump            Snd_S3_Continue_Jump05
