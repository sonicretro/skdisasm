	...
	dbglistobj Obj_AIZRideVine,		Map_AIZRideVine,		 $88, $21, make_art_tile(ArtTile_AIZSwingVine,0,0)
	...
	dbglistobj Obj_AIZ2FGTree,		Map_AIZ2FGTree,			   0,   0, make_art_tile(ArtTile_AIZBackgroundTree,2,0)
