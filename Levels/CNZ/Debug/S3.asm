	...
	dbglistobj Obj_Door,			Map_HCZCNZDoor,		   1,   1, make_art_tile($416,2,0)
	...
	dbglistobj Obj_BreakableWall,		Map_CNZBreakableWall,	   0,   0, make_art_tile($420,2,0)
	dbglistobj Obj_BreakableWall,		Map_CNZBreakableWall,	   2,   2, make_art_tile($420,2,0)
