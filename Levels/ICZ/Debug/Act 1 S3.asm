	...
	dbglistobj Obj_ICZPathFollowPlatform,	Map_ICZPlatforms,	   0,   0, make_art_tile(ArtTile_ICZMisc1,2,0)
	dbglistobj Obj_ICZPathFollowPlatform,	Map_ICZPlatforms,	   2,   0, make_art_tile(ArtTile_ICZMisc1,2,0)
	...
	dbglistobj Obj_ICZHarmfulIce,		Map_ICZPlatforms,	   0,   5, make_art_tile(ArtTile_ICZMisc1,2,0)
	dbglistobj Obj_ICZHarmfulIce,		Map_ICZPlatforms,	   2,   4, make_art_tile(ArtTile_ICZMisc1,2,0)
	...
	dbglistobj Obj_TensionBridge,		Map_ICZTensionBridge,	 $10,   0, make_art_tile(ArtTile_ICZMisc1,2,0)
