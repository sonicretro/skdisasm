	...
	dbglistobj Obj_CollapsingBridge,	Map_HPZCollapsingBridge, $80,   0, make_art_tile($001,2,0)
	dbglistobj Obj_SSZHPZTeleporter,	Map_SSZHPZTeleporter,	   0,  $A, make_art_tile(ArtTile_HPZTeleporter,0,0)
