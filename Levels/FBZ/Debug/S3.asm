	...
	dbglistobj Obj_Blaster,			Map_Blaster,			 $80,   0, make_art_tile($500,1,0)
	dbglistobj Obj_TechnoSqueek,		Map_TechnoSqueek,		   0,   0, make_art_tile($528,1,0)
	dbglistobj Obj_TechnoSqueek,		Map_TechnoSqueek,		   2,   0, make_art_tile($528,1,0)
	dbglistobj Obj_TechnoSqueek,		Map_TechnoSqueek,		   4,   0, make_art_tile($528,1,0)
